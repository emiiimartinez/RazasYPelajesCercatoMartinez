...
public enum AudioProvider {
    ...
    AudioProvider() {
        ...
        maleMap.put("Alazan Ruano", R.raw.f_alazan_ruano);
        maleMap.put("Blanco", R.raw.f_blanco);
        maleMap.put("Mestizo Qh Con Criollo", R.raw.m_mestizo_cuarto_de_milla);
        maleMap.put("Overo Azulejo", R.raw.f_overo_azulejo);
        maleMap.put("Alazan", R.raw.f_alazan);
        maleMap.put("Tobiano", R.raw.f_tobiano);
        maleMap.put("Tordillo Canela", R.raw.m_mestizo_tordillo_canela);
        maleMap.put("Cuarto De Milla", R.raw.m_cuarto_de_milla);
        maleMap.put("Bayo", R.raw.m_cuarto_de_milla_bayo);
